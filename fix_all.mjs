const sql = `
  ALTER TABLE Stock_Movimientos DROP CONSTRAINT FK_Stock_Movs_Remito;
  ...
  ADD CONSTRAINT FK_Stock_Movs_Remito 
  FOREIGN KEY (remito_id) REFERENCES wms_remitos_internos(id);
`;
