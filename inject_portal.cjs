...
if (code.includes('{/* FULLSCREEN PDF VISOR HISTORIAL */}')) {
    code = code.replace('{/* FULLSCREEN PDF VISOR HISTORIAL */}', injection);
    fs.writeFileSync('src/pages/InventarioGerencial.tsx', code);
    console.log('Injected Modal Intermediate and PDF Portal directly before FULLSCREEN PDF VISOR HISTORIAL');
}
